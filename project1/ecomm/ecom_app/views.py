...
from ecom_app.models import Product,cart,order
...
def range(request):
    #select * from product where price<=500 and price>50000 and is_active status=True;
...
def sendusermail(request):
    ...
    send_mail(
        ...
        msg,
        "chaitaligodse0@gmail.com",  #two step auth id
        ["ronitsuryarao4750@gmail.com"],
        fail_silently=False,
    )
